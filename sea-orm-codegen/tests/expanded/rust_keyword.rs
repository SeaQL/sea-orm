...
impl ColumnTrait for Column {
    ...
    fn def(&self) -> ColumnDef {
        match self {
            ...
            Self::Rust => ColumnType::TinyInteger.def().unsigned(),
            Self::Keywords => ColumnType::SmallInteger.def(),
            Self::Type => ColumnType::SmallInteger.def().unsigned(),
            Self::Typeof => ColumnType::Integer.def(),
            Self::Crate => ColumnType::Integer.def().unsigned(),
            Self::Self_ => ColumnType::BigInteger.def(),
            Self::SelfId1 => ColumnType::BigInteger.def().unsigned(),
