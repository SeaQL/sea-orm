...
mod one {
    ...
    pub struct Model {
        ...
        pub id: i32,
        #[sea_orm(has_one)]
        pub two: HasOne<Option<super::two::Entity>>,
        #[sea_orm(has_one)]
        pub six: HasOne<Option<super::six::Entity>>,
    }
...
mod two {
    ...
    pub struct Model {
        ...
        pub one: HasOne<super::one::Entity>,
        #[sea_orm(belongs_to, from = "three_id", to = "id")]
        pub three: HasOne<super::three::Entity>,
    }
...
mod three {
    ...
    pub struct Model {
        ...
        pub id: i32,
        #[sea_orm(has_one)]
        pub four: HasOne<Option<super::four::Entity>>,
    }
...
mod four {
    ...
    pub struct Model {
        ...
        #[sea_orm(belongs_to, from = "three_id", to = "id")]
        pub three: HasOne<Option<super::three::Entity>>,
        #[sea_orm(has_one)]
        pub five: HasOne<Option<super::five::Entity>>,
    }
...
mod composite_a {
    ...
    pub struct Model {
        ...
        pub right_id: i32,
        #[sea_orm(has_one)]
        pub b: HasOne<Option<super::composite_b::Entity>>,
    }
...
mod composite_b {
    ...
    pub struct Model {
        ...
        pub a: HasOne<super::composite_a::Entity>,
    }
...
#[sea_orm_macros::test]
fn test_delete_by_one_column_unique_keys() -> Result<(), DbErr> {
    let ctx = TestContext::new("test_delete_by_one_column_unique_keys");
    let db = &ctx.db;
    ...
    assert_eq!(
        unique_item::Entity::find_by_code(20).one(db)?.unwrap().id,
        2
    );
    ...
    assert!(unique_item::Entity::find_by_code(20).one(db)?.is_none());
