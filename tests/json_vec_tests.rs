...
pub async fn insert_json_string_vec_derive(db: &DatabaseConnection) -> Result<(), DbErr> {
    let json_vec = json_vec_derive::string_vec::Model {
        id: 2,
        str_vec: Some(json_vec_derive::string_vec::StringVec(vec![
            "4".to_string(),
            "5".to_string(),
            "6".to_string(),
        ])),
    ...
    let model = json_vec_derive::string_vec::Entity::find()
        .filter(json_vec_derive::string_vec::Column::Id.eq(json_vec.id))
        .one(db)
        .await?;
...
pub async fn insert_json_struct_vec_derive(db: &DatabaseConnection) -> Result<(), DbErr> {
    let json_vec = json_vec_derive::struct_vec::Model {
        id: 2,
        struct_vec: Some(vec![
            json_vec_derive::struct_vec::JsonColumn {
                value: "4".to_string(),
            },
            json_vec_derive::struct_vec::JsonColumn {
                value: "5".to_string(),
    ...
    let model = json_vec_derive::struct_vec::Entity::find()
        .filter(json_vec_derive::struct_vec::Column::Id.eq(json_vec.id))
        .one(db)
        .await?;
