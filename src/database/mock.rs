...
impl MockDatabaseTrait for MockDatabase {
    fn execute(&mut self, counter: usize, statement: Statement) -> Result<ExecResult, OrmError> {
    ...
    fn query(
        ...
        counter: usize,
        statement: Statement,
    ) -> Result<Vec<QueryResult>, OrmError> {
        self.transaction_log.push(Transaction::one(statement));
...
impl MockRow {
    pub fn try_get<T>(&self, col: &str) -> Result<T, OrmError>
    where
        T: ValueType,
    {
